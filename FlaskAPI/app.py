...
def reversePrompt():
    ...
    # First, let's get the description of the prompt
    description_messages = [
        {"role": "user", "content": "this was generated by chatgpt. what do you think the prompt that the user asked chat gpt was to generate this?\n\n" + user_prompt}
    ]
    ...
    try:
        ...
        # Next, let's get the response to the prompt
        reverse_messages = [
